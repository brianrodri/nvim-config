...
local which_key_mappings = {
    ...
    { "cog", ":Neotree toggle git_status<CR>", desc = "git-status files" },
    ...
    { "[og", ":Neotree focus git_status<CR>", desc = "git-status files" },
    ...
    { "]og", ":Neotree close git_status<CR>", desc = "git-status files" },
